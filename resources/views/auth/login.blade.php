        ...
        <div style="height: 100vh" class='bg-black p-5'>
            ...
            <main id="login" class="relative max-w-3xl px-4 sm:px-6 lg:px-8 flex flex-col justify-center sm:items-center mx-auto size-full before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples-dark/squared-bg-element.svg')] before:bg-no-repeat before:bg-top before:size-full before:-z-[1] before:transform before:-translate-x-1/2">
             <div class="text-center py-8 px-4 sm:px-6 lg:px-8">
               ...
               Your Time Matters, We Manage It
               </h1>
               ...
               <form method="post" action="{{ url('/login') }}">
                    ...
                    <div>
                        <label for="hs-cover-with-gradient-form-name-1" class="sr-only">Email</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="hs-cover-with-gradient-form-email-1" class="sr-only">Password</label>
                        <div class="relative">
                        ...
                        <div class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                            <svg class="flex-shrink-0 size-4 text-gray-400 dark:text-neutral-500"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/>
                    ...
                    <div class="grid">
                        ...
                        <p class="mt-2">
                            <p><a class="text-blue-600 hover:text-blue-500 opacity-90" href="{{ route('password.request') }}">I forgot my password</a></p>
                        </p>
                        <p class="mt-2">
                            <p><a class="text-blue-600 hover:text-blue-500 opacity-90" href="{{ route('register') }}">Register a new membership</a></p>
                        </p>
                    </div>
                    </div>
               </form>
            ...
            <footer class="absolute bottom-0 inset-x-0 text-center py-5">
             <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
               <p class="text-sm text-white/50">© 2024 WaitLess. A product of <a class="text-white font-medium hover:text-white/80" href="../index.html">Learnsoft Beliotech Solutions</a></p>
             </div>
            </footer>
            <!-- ========== END FOOTER ========== -->
            </div>
